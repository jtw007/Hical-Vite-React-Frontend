...
const Register = ({ currentUser, setCurrentUser }) => {
    ...
    return (
        <div id='register-container' style={{width: '100%', height: '100%', position: 'relative', background: 'white'}}>
            ...
            <div style={{width: 11.06, height: 11.06, left: 93, top: 463.83, position: 'absolute', background: '#D9D9D9', borderRadius: 2, border: '0.50px #5F6368 solid'}} />
            ...
            {/* <div style={{width: 26, height: 0, left: 116.51, top: 684.90, position: 'absolute', transform: 'rotate(-45deg)', transformOrigin: '0 0', border: '0.50px black solid'}}></div>
            <div style={{width: 26, height: 0, left: 115.81, top: 665.81, position: 'absolute', transform: 'rotate(45deg)', transformOrigin: '0 0', border: '0.50px black solid'}}></div> */}
                
                {/* <div style={{ width: 216.66, height: 17.83, left: 103, top: 34, position: 'relative', border: '1px solid red'}}>
                    <input 
                        style={{width: 256, height: 55, left: 0, top: 85, position: 'relative', borderRadius: 40, border: '1px rgba(95, 99, 104, 0.50) solid'}}
                        type="text"
                        id="name"
                        placeholder='name'
                        onChange={e => setName(e.target.value)}
